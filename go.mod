...
require (
	...
	github.com/netbirdio/signal-dispatcher/dispatcher v0.0.0-20250805121659-6b4ac470ca45 // indirect
...
replace github.com/netbirdio/netbird => github.com/dfarrel1/netbird v0.0.0-20260717153144-6fb9b15c062d
